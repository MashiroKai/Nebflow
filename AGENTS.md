...
- **Do not over-engineer** — finish the task and report; the smallest change that satisfies the requirement wins, and no abstraction, gate, or extra node is added ahead of a real need.
