...
class SessionService(store: SessionStore):
  ...
  def createSession(name: String, agentName: Option[String] = None, folderId: Option[String] = None, flowName: Option[String] = None, safetyMode: String = "confirm-edits"): IO[SessionMeta] =
