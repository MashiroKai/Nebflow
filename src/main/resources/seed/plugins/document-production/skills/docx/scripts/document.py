...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Nebflow", initials: str = "Z"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Nebflow")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Nebflow")
