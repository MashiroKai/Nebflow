...
All commands: `python3 "${SKILL_DIR}/xlsx.py" <command> [arguments]`
...
```bash
python3 "${SKILL_DIR}/xlsx.py" inspect input.xlsx --pretty   # understand structure
python3 "${SKILL_DIR}/xlsx.py" pivot input.xlsx output.xlsx \
