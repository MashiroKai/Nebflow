...
```bash
node "${SKILL_DIR}/scripts/html2pdf-next.js" input.html --output output.pdf --width 720px --height 1020px
```
...
```bash
python3 "${SKILL_DIR}/scripts/poster_validate.py" check-html <file>.html
```
