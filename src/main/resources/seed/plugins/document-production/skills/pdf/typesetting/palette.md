...
python3 "${SKILL_DIR}/scripts/design_engine.py" palette-cascade --intent cold --mode minimal

# Via pdf.py (auto-derives intent from title)
python3 "${SKILL_DIR}/scripts/pdf.py" palette.cascade --title "2025年度报告" --format reportlab
