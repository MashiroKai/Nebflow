...
const FS = [
  ...
  '  /* v8.2.8: feathered skirt tightened to the body silhouette only — alpha dies',
  '     just past the body edge (1.06r0) with a clean ~0.14r0 feather, so there is',
  '     no outer glow band. v8.2.6/7 widened the skirt (1.44r0 dark / 1.15r0 light)',
  '     to carry a soft fluorescent gradient; that gradient IS the outer ring the',
  '     user wants gone. The body (<=0.92r0) stays opaque (B9). */',
  '  float skirtEnd=r0*1.06;',
