...
export default {
  ...
  // === Plugins page (2026-09-04 part B: agents entry merged in, en/zh paired) ===
  'plugins.catalog': 'Plugin Catalog',
  'plugins.skills': 'Skills',
  'plugins.mcp': 'MCP Servers',
  'plugins.map': 'Agent Subscriptions',
  'plugins.mapHint': 'Click a skill chip to toggle the subscription; changes persist to agent.json via PUT /api/agents/:name',
  'plugins.config': 'Agent Configuration',
  'plugins.configHint': 'Preset and model settings migrated from the former agents panel',
  'plugins.subscribers': 'Subscribers',
  'plugins.none': 'none',
  'plugins.enabled': 'enabled',
  'plugins.disabled': 'disabled',
  'plugins.noSkills': 'No skills installed',
