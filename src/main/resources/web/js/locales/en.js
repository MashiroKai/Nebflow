...
export default {
  ...
  // === Plugins page (2026-09-13 no-gate batch: presence-trust + explicit block, en/zh paired) ===
  'plugins.list': 'Plugins',
  'plugins.listHint': 'Unified plugin system: skills and MCP enable per plugin. A plugin present on disk is trusted as-is — no approval step. The dispatch switch only affects FUTURE dispatches (nodes already running keep their grant); use Block on the plugin card to stop one plugin by name',
  ...
  'plugins.moreLabel': 'More actions',
  'plugins.blockAction': 'Block this plugin',
  'plugins.unblockAction': 'Unblock this plugin',
  'plugins.blockTitle': 'Block: keeps the plugin out of the dispatcher catalog, blocks new dispatches, and stops in-flight plugin MCP within 30s',
  'plugins.unblockTitle': 'Unblock: restores the plugin (its content is already in force)',
  'plugins.blockNote': 'Blocking is the only way to stop a single plugin by name. Unblocking restores it.',
  'plugins.blockedHint': 'Blocked — this plugin is out of the dispatcher catalog and will not be dispatched. Unblock it to restore.',
  'plugins.actionNoEffect': 'No effect on {name}: the registry still shows the previous state',
  ...
  'plugins.dispatchLabel': 'Dispatch to new nodes',
  ...
  'plugins.dispatchOffNote': 'Dispatch is off — affects FUTURE dispatches only; nodes already running keep their plugin grant',
  'plugins.dispatchBlockedBlocked': 'Blocked — unblock the plugin first (while it is blocked this switch cannot take effect)',
