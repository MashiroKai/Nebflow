...
export default {
  ...
  'preset.fieldName': 'Preset ID',
  'preset.fieldDisplayName': 'Display Name',
  'preset.fieldDescription': 'Description',
  'preset.fieldChain': 'Model Chain (first = preferred)',
  'preset.addModel': '+ Add Model',
  'preset.nameRequired': 'Preset ID is required',
  'preset.noSpaces': 'Preset ID cannot contain spaces',
