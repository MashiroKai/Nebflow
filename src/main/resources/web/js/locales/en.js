...
export default {
  ...
  'settings.updatePrompt': 'A new version is available. Update now?',
  ...
  // === Scheduled Tasks ===
  'task.panelTitle': 'Scheduled Tasks',
  'task.empty': 'No scheduled tasks',
  'task.emptyHint': 'Click empty area or press + to create',
  'task.create': 'New Task',
  'task.cancel': 'Cancel',
  'task.inputPlaceholder': 'Enter task...',
  'task.timeLabel': 'Trigger Time',
  'task.refLabel': 'Reference',
  'task.refPlaceholder': 'File path (optional, LLM will read this file)',
  'task.pendingCount': '{count} pending',
