...
export default {
  ...
  'plugins.listHint': 'Unified plugin system: skills and MCP enable per plugin. Two separate actions per card: the content switch approves/revokes the plugin contents; the dispatch switch only affects future dispatches (nodes already running keep their grant)',
  ...
  'plugins.switchLabel': 'Content approval switch',
  'plugins.switchEnableTitle': 'Approve the current content (grants content trust)',
  'plugins.switchReenableTitle': 'Re-approve the changed content',
  'plugins.switchDisableTitle': 'Revoke content trust (also stops in-flight plugin MCP)',
  'plugins.changedHint': 'Content changed since approval — re-enabling approves the new content',
  'plugins.offHint': 'Off (default-deny) — approving the content enables it',
  ...
  'plugins.dispatchBlockedUntrusted': 'Dispatch permission needs approved content — use the content switch first (while the content is unapproved this switch cannot take effect)',
