...
export default {
  ...
  'chat.frozenHint': 'In a freeze window. Sending a message wakes the agent immediately.',
  'chat.frozenWakeHint': 'Send a message to wake the agent…',
  'chat.frozenShort': 'Frozen · {time} resume',
  'chat.frozenCancel': 'Cancel freeze',
  ...
  'chat.thoughtMoment': 'Thought for a moment',
