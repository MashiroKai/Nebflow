...
export default {
  ...
  'chat.other': '其他...',
  'chat.frozen': '已冻结 · 将于 {time} 恢复继续',
  'chat.frozenNoTime': '已冻结 · 等待恢复',
  'chat.frozenHint': '处于冻结时段。发送消息可立即唤醒。',
  'chat.frozenWakeHint': '发送消息立即唤醒 agent…',
  'chat.frozenShort': '已冻结 · {time} 恢复',
  'chat.frozenCancel': '取消冻结',
  'chat.frozenCanceled': '已取消全局冻结',
