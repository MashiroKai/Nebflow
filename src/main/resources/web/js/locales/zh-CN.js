...
export default {
  ...
  // === 插件页（2026-09-04 件 B：智能体入口融合，en/zh 成对） ===
  'plugins.catalog': '插件清单',
  'plugins.skills': '技能',
  'plugins.mcp': 'MCP 服务器',
  'plugins.map': '智能体订阅映射',
  'plugins.mapHint': '点按技能切换订阅，改动经 PUT /api/agents/:name 写入 agent.json',
  'plugins.config': '智能体配置',
  'plugins.configHint': '自原智能体面板平移的 preset 与模型配置',
  'plugins.subscribers': '订阅智能体',
  'plugins.none': '无',
  'plugins.enabled': '已启用',
  'plugins.disabled': '已停用',
  'plugins.noSkills': '未安装技能',
