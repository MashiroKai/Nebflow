...
export default {
  ...
  'plugins.list': '插件',
  'plugins.listHint': '统一插件系统：技能与 MCP 以插件为单位。每卡两个动作分开：内容开关审批/撤回插件内容；派发开关只影响未来派发（已在跑的节点保持其许可）',
  'plugins.agents': '智能体',
  'plugins.agentsHint': '点按智能体行进入详情编辑（工具 / 提示词 / 流程）',
  'plugins.empty': '暂无插件',
  'plugins.stateOn': '已启用',
  'plugins.stateOff': '未启用',
  'plugins.switchLabel': '内容审批开关',
  'plugins.switchEnableTitle': '按当前内容审批（授予内容信任）',
  'plugins.switchReenableTitle': '按已变更的内容重新审批',
  'plugins.switchDisableTitle': '撤回内容信任（会停用在飞节点的插件 MCP）',
  'plugins.changedHint': '内容已变更，重新启用将按新内容审批',
  'plugins.offHint': '未启用（默认拒绝）——审批当前内容即启用',
  ...
  'plugins.dispatchBlockedUntrusted': '派发许可需要先审批内容——请先用内容开关审批（内容未审批时，单点派发开关不会生效）',
