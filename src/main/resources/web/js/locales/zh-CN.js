...
export default {
  ...
  'settings.workSchedule': '工作时间（冻结调度）',
  'settings.workScheduleOnHint': '工作时间段之外，agent 在工具执行完成后自动冻结，不调用 LLM（零 token 消耗），到点自动恢复继续。发送消息可随时唤醒。',
  'settings.workScheduleOffHint': '默认关闭。关闭时所有 agent 全天候工作，行为与现状完全一致。',
  'settings.addSegment': '添加时段',
  'settings.removeSegment': '删除该时段',
  'settings.segmentLabel': '段 {n}',
  'settings.segmentTo': '至',
  'settings.scheduleInvalidTime': '时间格式应为 HH:mm',
  'settings.scheduleInvalidRange': '时段起点必须早于终点',
  'settings.scheduleEmpty': '开启时至少需要一段工作时间',
  'settings.scheduleCrossDay': '跨天时段暂不支持',
  'settings.scheduleSaved': '工作时间已保存',
  ...
  'chat.frozenHint': '非工作时间。发送消息可立即唤醒。',
