...
export default {
  ...
  'onboarding.welcomeTitle': '欢迎使用 {brand}',
  'onboarding.welcomeSubtitle': '本地优先的 AI 工作台：会话、团队、流程。先花一分钟完成初始配置。',
  'onboarding.start': '开始配置',
  'onboarding.skip': '跳过',
  'onboarding.providerTitle': '配置模型',
  'onboarding.providerHint': '{brand} 需要一个 LLM 服务商才能工作。添加一个服务商和模型即可继续。',
  ...
  'onboarding.doneTitle': '模型已就绪',
  'onboarding.doneNote': '点击完成后，Nebula 将向你发送第一条消息，简单了解你的使用偏好。',
  'onboarding.finish': '完成',
  'onboarding.returnTitle': '欢迎使用 {brand}',
  'onboarding.returnHint': '检测到升级前已完成配置。要不要让 Nebula 自我介绍一下，并了解你的使用偏好？',
  'onboarding.greet': '打个招呼',
