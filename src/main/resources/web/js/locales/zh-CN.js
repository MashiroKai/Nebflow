...
export default {
  ...
  'neblink.nlIdLabel': 'NL 号',
  'neblink.nlIdDefault': '默认为注册邮箱',
  'neblink.nlIdEdit': '修改',
  'neblink.nlIdPlaceholder': '3-32 位字母或数字',
  'neblink.nlIdRules': '仅限字母和数字，长度 3-32；修改后好友可通过新号找到你',
  'neblink.nlIdAvailable': '该号可用',
  'neblink.nlIdTaken': '该号已被占用',
  'neblink.nlIdInvalid': '格式不符：仅字母和数字，长度 3-32',
  'neblink.nlIdChecking': '检测中…',
  'neblink.nlIdSaving': '保存中…',
  'neblink.nlIdSaved': 'NL 号已更新',
  'neblink.nlIdSaveFailed': '保存失败，请重试',
  ...
  'flows.indicatorTitle': '运行中的工作流',
  'flows.running': '运行中的工作流 · {count}',
  'flows.none': '当前无运行中的工作流',
  'flows.cancel': '取消',
  ...
  'plugins.detail': '详情',
  'flowTeams.noActive': '暂无活跃团队',
  'flowTeams.mountHint': '挂载一个团队以查看其智能体',
  ...
  'entity.node': '节点',
  'flows.section': '工作流',
  'flows.definitions': '工作流定义',
  'flows.viewDag': '查看 DAG',
  'flows.nodesCount': '{count} 节点',
  'flows.maxLoop': '循环上限 {n}',
  'flows.entry': '入口: {name}',
  'flows.status.running': '运行中',
  'flows.status.completed': '已完成',
  'flows.status.failed': '失败',
  'flows.status.cancelled': '已取消',
  'flows.status.definition': '定义',
  'flows.status.idle': '空闲',
  'flows.completed': '工作流已完成',
  'flows.failed': '工作流失败',
  'flows.close': '关闭',
  'flows.cancelFlow': '取消工作流',
  'flows.noRunning': '无运行中的工作流',
  'flows.noRunningHint': '通过 Delegate 触发工作流后在此查看',
  'flows.notFound': '未找到工作流实例',
  'flows.noData': '无工作流数据',
  'flows.loadingDag': '正在加载 DAG…',
  'flows.agentsRunning': '{count} 运行中',
  'flows.agentsIdle': '{count} 空闲',
  'flows.role.manager': '管理者',
