...
export default {
  ...
  // === 插件页（2026-09-13 无审批批：在位即信任 + 点名封禁，en/zh 成对） ===
  'plugins.list': '插件',
  'plugins.listHint': '统一插件系统：技能与 MCP 以插件为单位。插件在位即受信——装好即可用，无需审批。派发开关只影响未来派发（已在跑的节点保持其许可）；要停掉某个插件，用卡片上的「封禁」',
  'plugins.agents': '智能体',
  ...
  'plugins.moreLabel': '更多操作',
  'plugins.blockAction': '封禁该插件',
  'plugins.unblockAction': '解封该插件',
  'plugins.blockTitle': '封禁：该插件不进分发器目录、不再派给新节点，并在 30 秒内停用在飞节点的插件 MCP',
  'plugins.unblockTitle': '解封：恢复正常（内容面已生效）',
  'plugins.blockNote': '封禁是唯一点名止损手段；解封即恢复。',
  'plugins.blockedHint': '已封禁——该插件不进目录、不会被派发。解封后恢复。',
  'plugins.actionNoEffect': '对 {name} 未生效：注册表仍显示原状态',
  'plugins.changedHint': '内容与上次记录的版本不同——已按新内容生效，此提示仅为可见性（无需再审批）',
  'plugins.dispatchLabel': '派发许可（仅新节点）',
  'plugins.dispatchOnTitle': '派发许可已开启——可派给新节点。点击后只挡未来派发；已在跑的节点保持其许可',
  'plugins.dispatchOffTitle': '派发许可已关闭——不会再派给新节点。点击恢复派发',
  'plugins.dispatchOffNote': '派发已关闭——只影响未来派发；已在跑的节点保持其插件许可',
  'plugins.dispatchBlockedBlocked': '已封禁——先解封（封禁期间本开关不会生效）',
