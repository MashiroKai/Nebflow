...
export function applyLocaleToHtml() {
  ...
  const map = {
    ...
    'conflict-title': ['text', 'explorer.conflictTitle'],
    'conflict-cancel': ['text', 'modal.cancel'],
    'conflict-keep-both': ['text', 'explorer.conflictKeepBoth'],
    'conflict-replace': ['text', 'explorer.conflictReplace'],
